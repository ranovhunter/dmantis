<div class="card">
    <div class="card-body">
        ...
        <form class="row g-3 needs-validation" novalidate action="<?php echo site_url('area/detail/' . $rec_data->id); ?>" method="post" role="form" autocomplete="off">
            <div class="col-md-6">
                <div class="form-floating">
                    <input type="text" name="txt_name" class="form-control" id="floatingName" placeholder="Item Name" value ="<?= set_value('txt_name', $area->name) ?>" required>
