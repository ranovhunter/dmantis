<ul class="nav nav-tabs d-flex" id="myTabjustified" role="tablist">
    ...
    <li class="nav-item flex-fill" role="presentation">
        <a class="nav-link w-100 <?= $curr_poss == 'ready' ? 'active' : '' ?>" id="active-tab" href="<?= site_url('rent/ready'); ?>" type="button" aria-controls="profile" aria-selected="false">Approved Rent</a>
    </li>
    <li class="nav-item flex-fill" role="presentation">
